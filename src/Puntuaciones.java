...
public class Puntuaciones extends javax.swing.JFrame implements Runnable{
    private HashMap<String,Long> victorias;
    public Puntuaciones(HashMap<String,Long> victorias) {
    ...
    public void run()
    {
        if(victorias == null)
        {
            jTextArea1.append("no se ha conectado todavia con el servidor");
        }
        else
        {
            initComponents();
            ...
            for(String nombre : victorias.keySet()) {
                jTextArea1.append(nombre + " ha ganado " + victorias.get(nombre)+" veces");
            }
        }
    }
    
    public void lanzaPuntuaciones()
    {
